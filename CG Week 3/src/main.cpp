...
std::string windowTitle = "Joshua Yap - 100780233";
...
int main() {
	...
	static const float interleaved[] = {
		// X      Y    Z       R     G     B
		 0.9f, -0.2f, 0.5f,   0.0f, 0.0f, 0.0f,
		 0.9f,  0.8f, 0.5f,   0.3f, 0.2f, 0.5f,
		-0.1f,  0.8f, 0.5f,   1.0f, 1.0f, 0.0f,
		-0.1f, -0.2f, 0.5f,   1.0f, 1.0f, 1.0f
	};
